            ...
            <form class="form-horizontal">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input id="nombre" name="nombre" placeholder="Nombre del nivel" class="form-control input-md" required="" type="text">
                  <span class="help-block">Hasta 50 caracteres (punto, espacio y alfabéticos)</span>  
                  </div>
                </div>
